...
- Task 01: Port frontend [W25-P01-T01-FRONTEND]
  Verify: `fuse check stage2/src/compiler/lex/...`
- Task 02: Port driver [W25-P01-T02-DRIVER]
  Verify: `fuse build stage2/src/... -o stage2_out/fusec2`

## Phase 02: First Self-Compilation [W25-P02-SELF-COMPILE]

- Task 01: stage1 compiles stage2 [W25-P02-T01-STAGE1-COMPILES-STAGE2]
  Verify: `fuse build stage2/src/... -o stage2_out/fusec2`
- Task 02: stage2 compiles itself [W25-P02-T02-STAGE2-COMPILES-ITSELF]
  Verify: `stage2_out/fusec2 build stage2/src/... -o stage2_out/fusec2_gen2`

## Phase 03: Reproducibility [W25-P03-REPRO]

- Task 01: Bootstrap reproducibility [W25-P03-T01-REPRO]
  Verify: `make repro`
- Task 02: Gate merges on bootstrap health [W25-P03-T02-GATE]
