...
## Phase 01: Core Traits and Primitives [W20-P01-TRAITS]

- Task 01: Core traits [W20-P01-T01-TRAITS]
  Verify: `fuse build stdlib/core/traits/...`
- Task 02: Primitive methods [W20-P01-T02-PRIM]
  Verify: `fuse build stdlib/core/primitives/...`
- Task 03: Re-export intrinsic marker and callable traits
  [W20-P01-T03-REEXPORT]
  Verify: `go test ./tests/... -run TestCoreReExports -v`

## Phase 02: Strings, Collections, Iteration [W20-P02-COLLECTIONS]

- Task 01: `String` and formatting [W20-P02-T01-STRING]
  Verify: `fuse build stdlib/core/string/...`
- Task 02: `List`, `Map`, `Set`, iterators [W20-P02-T02-COLLECTIONS]
  Verify: `fuse build stdlib/core/collections/...`

## Phase 03: Interior Mutability [W20-P03-INTERIOR-MUT]

- Task 01: `Cell[T]` [W20-P03-T01-CELL]
...
- Task 02: `RefCell[T]` with runtime borrow tracking [W20-P03-T02-REFCELL]
...
## Phase 04: Pointer and Memory Surface [W20-P04-PTR-MEM]

- Task 01: `Ptr.null[T]()` API [W20-P04-T01-NULL]
  Verify: `go test ./tests/... -run TestPtrNull -v`
- Task 02: `size_of[T]()` / `align_of[T]()` wrappers [W20-P04-T02-SIZEOF]
  Verify: `go test ./tests/... -run TestSizeOfWrappers -v`

## Phase 05: Overflow-Aware Arithmetic Methods [W20-P05-OVERFLOW]

- Task 01: `wrapping_*`, `checked_*`, `saturating_*` methods
  [W20-P05-T01-OVERFLOW-METHODS]
  Verify: `go test ./tests/... -run TestOverflowMethods -v`

## Phase 06: Runtime Bridge [W20-P06-BRIDGE]

- Task 01: Core bridge files [W20-P06-T01-FILES]
  Verify: `fuse build stdlib/core/rt_bridge/...`
- Task 02: Docs coverage [W20-P06-T02-DOC]
